 ...
 * a null DecorView.
 */
internal class JankStatsAggregator(
    window: Window,
    ...
    val jankStats = JankStats.createAndTrack(window, listener).apply {
        this.jankHeuristicMultiplier = JankMonitor.JANK_MULTIPILER
    }
    ...
    companion object {
         ...
         */
        private const val REPORT_BUFFER_LIMIT = 5
    }
}