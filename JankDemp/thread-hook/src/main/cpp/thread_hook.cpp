...
void thread_hooked_callback(bytehook_stub_t task_stub, int status_code, const char *caller_path_name,
...
Java_com_example_thread_1hook_NativeLib_hookThread(
        JNIEnv *env,
        jobject /* this */) {
    hookThread();
}
...
Java_com_example_thread_1hook_NativeLib_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
