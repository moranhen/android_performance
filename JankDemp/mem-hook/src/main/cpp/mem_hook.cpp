...
Java_com_example_mem_1hook_NativeLib_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_example_mem_1hook_NativeLib_hookMemory(
        JNIEnv* env,
        jobject /* this */) {
    hookMemory();
}
extern "C" JNIEXPORT void JNICALL
Java_com_example_mem_1hook_NativeLib_dump(
        JNIEnv* env,
        jobject /* this */) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_mem_1hook_NativeLib_testMalloc(
        JNIEnv *env,
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_mem_1hook_NativeLib_testFree(
        JNIEnv *env,
        jobject /* this */) {
    if (!objList.empty()) {
